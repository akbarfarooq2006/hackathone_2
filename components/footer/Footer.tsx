         ...
         <div className='flex flex-row justify-between items-start flex-wrap gap-x-8 gap-y-8'>
            ...
            <div>
                <ul className='flex flex-col gap-y-5'>
                    ...
                    <li className='text-base font-medium capitalize text-black/60'>How it works</li>
                    <li className='text-base font-medium capitalize text-black/60'>Featured</li>
                    <li className='text-base font-medium capitalize text-black/60'>Partnership</li>
                    <li className='text-base font-medium capitalize text-black/60'>Bussiness Relation</li>
                </ul>
            </div>
            {/* list 2 */}
            <div>
                <ul className='flex flex-col gap-y-5'>
                    ...
                    <li className='text-base font-medium capitalize text-black/60'>Discord</li>
                    <li className='text-base font-medium capitalize text-black/60'>Instagram</li>
                    <li className='text-base font-medium capitalize text-black/60'>Twitter</li>
                    <li className='text-base font-medium capitalize text-black/60'>Facebook </li>
                </ul>
            </div>
            {/* list3 */}
            <div>
                <ul className='flex flex-col gap-y-5'>
                    ...
                    <li className='text-base font-medium capitalize text-black/60'>Events</li>
                    <li className='text-base font-medium capitalize text-black/60'>Blog</li>
                    <li className='text-base font-medium capitalize text-black/60'>Podcast</li>
                    <li className='text-base font-medium capitalize text-black/60'>Invite a friend </li>
                </ul>
            </div>
         </div>
        </div> 
