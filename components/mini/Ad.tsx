...
const Ad:React.FC<bg>= ({bg="ad1", btn,scrc,className,heading,para}) => {
  return (
<>
<div className={`bd:inline-block ${className} h-full hover:scale-[1.03] down`}>
    <div className={`${bg} w-full  rounded-[10px] py-8 px-5 h-full`}>
        ...
        <div className='sm:w-[60%] w-[90%] flex flex-col gap-y-3'>
            ...
            <Link href={'/'} className=''>
            <button className={`cursor-pointer ${btn}  text-secondary text-base font-semibold py-2 px-3 rounded-md capitalize down hover:scale-105 ` }>
                rental car
            </button>
            </Link>
        </div>
