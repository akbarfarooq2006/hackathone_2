...
const {liked,setliked,count,setcount,value} = useLikeContext();
  ...
  return (
    <div>
      <Link href={'/like-products'} className='cursor-pointer   '>
          <div before-dynamic-value={count} className={ `border-[1px] border-secondary2/40 rounded-full p-1 relative 
             before:absolute  before:-top-2 before:-right-1 before:rounded-full  before:text-xs before before:content-[attr(before-dynamic-value)] 
